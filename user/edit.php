        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><i class="fa fa-plus">Edit User</i></li>
                </ol>
            </section>
                            ...
                            <form role="form" method="post" action="proses_edit.php">
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama" class="form-control" id="exampleInputEmail1" value="<?= $row['name']; ?>">
                                    </div>
                                    <div class=" form-group">
                                    ...
                                    <div class=" form-group">
                                        ...
                                        <input type="password" name="passwd" class="form-control" id="exampleInputPassword1" placeholder="Tulis password anda...">
                                    </div>
                                </div>
                        </div>
                        <!-- /.box-body -->
